    ...
    return (
      <div className="flex items-center gap-3 p-1.5 pr-3 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 opacity-60 shadow-sm">
        ...
        <div className="hidden md:block text-left">
          ...
          <p className="text-[9px] text-slate-500 font-medium font-mono tracking-tighter uppercase">
            No Session
          </p>
        </div>
      </div>
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <ChevronDown
          className={`w-3 h-3 text-slate-400 group-hover:text-primary transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
            ...
            <div className="px-3 py-2 flex items-center justify-between gap-3">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-[11px] font-bold text-slate-700 dark:text-slate-300 leading-none">
                    Monochrome Map
                  </p>
                  <p className="text-[9px] text-slate-400 mt-0.5">
                    Bus icons stand out on greyscale
                  </p>
                </div>
              </div>
              <button
